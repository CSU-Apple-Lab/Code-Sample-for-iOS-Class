...
{
    NoteBookData *data = [self.noteBookDataArray objectAtIndex:indexPath.row];
    CGSize size = [data.content sizeWithFont:[UIFont systemFontOfSize:14.0f] constrainedToSize:CGSizeMake(self.view.frame.size.width - 16.0f, 20000) lineBreakMode:UILineBreakModeWordWrap];
    return size.height + 65.0f;
}
